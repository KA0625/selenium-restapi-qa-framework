...
public class TC8_SouthEast_JSON_CountyWebsiteValidate extends BaseTest {
	
		Page2CountyExpolorerPage p2;
		Page3CountyInfo p3;
		
		@DataProvider(name = "South" , parallel = true)
		public Object[][] countyFipsProvider(ITestContext context) throws IOException  {
			
			p2 = p1.GoToCountyExplorer();
			p2.toggleclick(); 
			JsonReader reader = new JsonReader();
			 List<String> states = reader.getStateCodestc8Json();
