...
public class TC6_South_JSON_CountyWebsitevalidate extends BaseTest {
	...
	@DataProvider(name = "SouthRegionFipsData" , parallel = true)
	public Object[][] countyFipsProvider(ITestContext context) throws IOException  {
		
		p2 = p1.GoToCountyExplorer();
		p2.toggleclick(); 
		JsonReader reader = new JsonReader();
		 List<String> states = reader.getStateCodestc6Json();
	...
	@Test(dataProvider = "SouthRegionFipsData")
